...
###colon 
p_value_colon=matrix(data=0,nrow = length(colon_list)/2,ncol = 5)
...
###melanoma
p_value_melanoma=matrix(data=0,nrow = length(melanoma_list)/2,ncol = 5)
...
###oesophagus
p_value_oesophagus=matrix(data=0,nrow = length(oesophagus_list)/2,ncol = 5)
...
###stomach
p_value_stomach=matrix(data=0,nrow = length(stomach_list)/2,ncol = 5)
...
###pancreas
p_value_pancreas=matrix(data=0,nrow = length(pancreas_list)/2,ncol = 5)
...
###lusc
p_value_lusc=matrix(data=0,nrow = length(lusc_list)/2,ncol = 5)
...
###luad
p_value_luad=matrix(data=0,nrow = length(luad_list)/2,ncol = 5)
...
###liver
p_value_liver=matrix(data=0,nrow = length(liver_list)/2,ncol = 5)
...
###kindey
p_value_kindey=matrix(data=0,nrow = length(kindey_list)/2,ncol = 5)
...
###bladder
p_value_bladder=matrix(data=0,nrow = length(bladder_list)/2,ncol = 5)
...
###rectum
p_value_rectum=matrix(data=0,nrow = length(rectum_list)/2,ncol = 5)
...
colnames(p_value_colon)=c("country", "beta", "SE","p_value","R2")
colnames(p_value_bladder)=c("country", "beta", "SE","p_value","R2")
colnames(p_value_kindey)=c("country", "beta", "SE","p_value","R2")
colnames(p_value_liver)=c("country", "beta", "SE","p_value","R2")
colnames(p_value_luad)=c("country", "beta", "SE","p_value","R2")
colnames(p_value_lusc)=c("country", "beta", "SE","p_value","R2")
colnames(p_value_melanoma)=c("country", "beta", "SE","p_value","R2")
colnames(p_value_oesophagus)=c("country", "beta", "SE","p_value","R2")
colnames(p_value_pancreas)=c("country", "beta", "SE","p_value","R2")
colnames(p_value_rectum)=c("country", "beta", "SE","p_value","R2")
colnames(p_value_stomach)=c("country", "beta", "SE","p_value","R2")
